    ...
    $('#formClientes').validate({
        ...
        messages:{
            ...
            cnpj: {
				...
				cnpjBR: 'Por favor, informe um numero de cpf válido'
            }
        },
        errorElement: "em",
            ...
            $.ajax({
                ...
                success: function (retorno) {
                    ...
                    if( retorno.sucesso == 1 ) {	
                        swal({
                            title: 'Sucesso!',
                            text: 'Deseja cadastrar um novo clientes?',
                            type: 'success',
...
function ExcluiEndereco(id){
    swal({
        ...
        $.ajax({
            url: base_url + 'call/fornecedorEnderecoDelete',
            type: "POST",
            dataType: 'json',
            data: {id:id},
            success: function (retorno) {
